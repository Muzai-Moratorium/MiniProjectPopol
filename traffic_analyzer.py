...
DB_URL = "mysql+pymysql://flask_user:1234@localhost:3306/flask_db?charset=utf8mb4"
...
TARGET_CCTV_FILTERS = [
    ...
    "[경부선] 서울영업소-광장", "[경부선] 금곡교", "[경부선] 죽전휴게소", "[경부선] 죽전",
    "[경부선] 신갈분기점", "[경부선] 신갈분기점2", "[경부선] 수원", "[경부선] 공세육교",
    "[경부선] 기흥휴게소", "[경부선] 기흥", "[경부선] 기흥동탄", 
    "[부산]경부동탄터널(입구방음터널)",
    "[부산]경부동탄터널(부산1)", "[부산]경부동탄터널(부산2)", "[부산]경부동탄터널(부산3)",
    "[부산]경부동탄터널(부산4)", "[부산]경부동탄터널(부산5)", "[부산]경부동탄터널(출구방음터널)",
    "[부산]경부동탄터널(출구)", 
    "[경부선] 동탄분기점", "[경부선] 부산동",
    "[경부선] 오산", "[경부선] 원동", "[경부선] 남사육교", "[경부선] 외동천교", "[경부선] 진위천교",
    "[경부선] 남사졸음쉼터", "[경부선] 남사정류장", "[경부선] 산하", "[경부선] 안성휴게소2",
    "[경부선] 안성휴게소(서울)", "[경부선] 원곡", "[경부선] 안성분기점1", "[경부선] 안성분기점2",
    "[경부선] 안성휴게소(부산)", "[경부선] 공도", "[경부선] 원곡졸음쉼터", "[경부선] 안성"
]
